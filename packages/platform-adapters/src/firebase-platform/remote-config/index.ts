...
export const fetchRemoteConfigTemplate = (): Promise<RemoteConfigTemplate> => remoteConfig().getTemplate();

export const publishRemoteConfigTemplate = (template: RemoteConfigTemplate): Promise<RemoteConfigTemplate> =>
