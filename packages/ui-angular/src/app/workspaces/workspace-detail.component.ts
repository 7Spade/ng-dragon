...
@Component({
  ...
  standalone: true,
  imports: [NgIf, NgFor, ...SHARED_IMPORTS, NzDescriptionsModule, NzSkeletonModule, NzAlertModule],
  template: `
        ...
        <nz-descriptions nzBordered [nzColumn]="1">
          <nz-descriptions-item nzTitle="Modules">
            <ng-container *ngIf="workspace()?.modules?.length; else noModulesTpl">
              <nz-tag *ngFor="let module of workspace()?.modules" [nzColor]="module.enabled ? 'green' : 'default'" class="mb-sm">
